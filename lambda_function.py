...
SKILL_NAME = "Facts for Elder Scrolls"
...
def _get_fact_speech():
    return "Here's your Elder Scrolls fact: Did you know " + random.choice(FACTS)
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speech = (
            "You can ask Facts for Elder Scrolls to tell me an Elder Scrolls fact, "
